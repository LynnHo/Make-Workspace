# Generated by Powerlevel10k configuration wizard on 2023-10-04 at 23:46 CST.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh.
# Wizard options: flat, large icons, ascii, lean_8colors, 2 lines, dotted,
...
() {
  ...
  typeset -g POWERLEVEL9K_SHORTEN_DIR_LENGTH=10000
  ...
  CONTEXT=%F{cyan}$USER@${$(echo $SSH_CONNECTION | awk '{print $3}'):-$(/bin/hostname -I | awk '{print $1}')}%f
  ...
  typeset -g POWERLEVEL9K_ANACONDA_FOREGROUND=13
