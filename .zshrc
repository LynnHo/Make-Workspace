...
zstyle ':fzf-tab:complete:*:*' fzf-preview '
    ...
    view=$([[ ! -d $item ]] && viu -w 64 $item || [[ $(file --mime-type -b $item) == text/* && $(stat -c%s $item) -gt 52428800 ]] && echo "Too large text to preview"|| less $item) 2>/dev/null && (clear; echo $info; echo $(hl \[SIZE\]) $size; echo \\n$(hl \[VIEW\])\\n$(hl ------); echo $view)
'
